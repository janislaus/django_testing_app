...
class BasisCompanyApiTestCase(TestCase):
    def setUp(self) -> None:
        self.client = Client()
...
class TestGetCompanies(BasisCompanyApiTestCase):
...
class TestPostCompanies(BasisCompanyApiTestCase):
...
def test_logged_info_level(caplog) -> None:
    with caplog.at_level(logging.INFO):
        logger.info("I am loggin info level")
